...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-bg-secondary border-t border-border-default flex justify-around items-center px-2 py-1.5 md:hidden">
      {NAV_ITEMS.map((item) => {
